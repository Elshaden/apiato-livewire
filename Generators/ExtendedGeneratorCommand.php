...
use Symfony\Component\Console\Input\InputOption;
 ...
 class ExtendedGeneratorCommand   extends   Command
{
     ...
     */
    private const CUSTOM_STUB_PATH = 'Stubs/*';
     ...
     * @var string
     */
    private const DEFAULT_SECTION_NAME = 'Livewire';
    ...
    protected function getStubContent()
    {
        ...
        $path = app_path() . '/Vendor/Livewire/Generators/' . self::CUSTOM_STUB_PATH;
